...
#define FONTSYS_TARGETHEIGHT	M_CLIENT_HEIGHT
...
public:
	...
	static void SignUp(BYTE ID, const char * text = NULL);
	static void Render(BYTE ID, float x, float y, DWORD ucol, DWORD dcol, float hext = 0, float vext = 0);
